...
declare function onEvent(name: `mm`, handler: (event: io.ticticboom.mods.mm.compat.kube.recipe.RecipeEventJS) => void);
...
declare function onForgeEvent(name: "com.github.tartaricacid.touhoulittlemaid.api.event.MaidTickEvent", handler: (event: Internal.MaidTickEvent) => void);
...
declare function onForgeEvent(name: "com.github.tartaricacid.touhoulittlemaid.api.event.InteractMaidEvent", handler: (event: Internal.InteractMaidEvent) => void);
...
declare function onForgeEvent(name: "com.github.tartaricacid.touhoulittlemaid.api.event.MaidDamageEvent", handler: (event: Internal.MaidDamageEvent) => void);
...
declare function onForgeEvent(name: "com.github.tartaricacid.touhoulittlemaid.api.event.MaidHurtEvent", handler: (event: Internal.MaidHurtEvent) => void);
...
declare function onForgeEvent(name: "com.github.tartaricacid.touhoulittlemaid.api.event.MaidPlaySoundEvent", handler: (event: Internal.MaidPlaySoundEvent) => void);
...
declare function onForgeEvent(name: "com.github.tartaricacid.touhoulittlemaid.api.event.MaidAttackEvent", handler: (event: Internal.MaidAttackEvent) => void);
